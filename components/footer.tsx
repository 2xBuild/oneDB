      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-wrap sm:flex-col items-center justify-center gap-1.5">
          <p className="text-sm text-muted-foreground">
            ©{new Date().getFullYear()} oneDB. <Link href="https://github.com/void/10-oneDB" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">Open source and community-driven</Link>.
          </p>
          <p className="text-sm text-muted-foreground">
